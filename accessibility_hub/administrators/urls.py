...
urlpatterns = [
    ...
    path('goedkeuren/', views.goedkeuren_ervaringsdeskundige, name='goedkeuren_ervaringsdeskundige'),
    path('afkeuren/', views.afkeuren_ervaringsdeskundige, name='afkeuren_ervaringsdeskundige'),
